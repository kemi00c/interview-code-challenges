...
{
    public class SeedDataWithOverdueBook
    {
        public static void SetInitialData()
        {
            ...
            var bookOnLoanUntilYesterday = new BookStock
            {
                Book = clayBook,
                OnLoanTo = lianaJames,
                LoanEndDate = DateTime.Now.AddDays(-1).Date
            };

            var bookOverdue = new BookStock
            {
                Book = agileBook,
                OnLoanTo = lianaJames,
                LoanEndDate = DateTime.Now.Date.AddDays(-7).Date
            };
            ...
            using (var context = new LibraryContext())
            {
                ...
                context.Catalogue.Add(bookOnLoanUntilYesterday);
                context.Catalogue.Add(bookOverdue);
